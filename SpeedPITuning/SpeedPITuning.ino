/**********************************************
 ...
 You can adjust the kp ki in real time by 
 rotating the joystick in the x or y direction 
 ------------------Jinqiao--------------------
*********************************************/
...
float kp = 5;             // Initial Propotional Control Gain
float ki = 3;             // Initial Integral Control Gain
...
void loop(){
  ...
  sqTarg = 150 * (sin(6.28 * 0.5 * currT/1e6) > 0);// Square Wave with Amplitude 150 
